...
npm run tauri build
```
Your built binary will be located in `src-tauri/target/release/bundles`. The directory within /bundles containing the binary depends on your operating system. You can then run your compiled binary by following the platform-specific instructions for your operating system listed above.
